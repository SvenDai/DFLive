...
@implementation DFBrightnessView

+(instancetype) sharedBrightnessView{
    static DFBrightnessView *instance;
    
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [[DFBrightnessView alloc]init];
...
-(instancetype) init{
    if (self = [super init]) {
        self.frame = CGRectMake(DF_SCREEN_WIDTH * 0.5, DF_SCREEN_HEIGHT * 0.5, 155, 155);
...
- (void)layoutSubviews {
    ...
    self.center = CGPointMake(DF_SCREEN_WIDTH * 0.5, DF_SCREEN_HEIGHT * 0.5);
}
